        ...
        <div class="row">
            <div class="col-md-2 bg-dark" style="color: white">
                ...
                <div class="vertical-menu">
                    <ul>
                        ...
                        <hr style="background-color: white">
                        <li><h5><span href="" onclick="onClickCreateUser()">Create user</span></h5></li>
                        <hr style="background-color: white">
            ...
            <div class="col-md-10" style="width: 70%; padding: 10px; align-content: center;" ng-app="sortApp">
                            ...
                            <form method="get" action="{{route('events.search')}}">
                                <div class="input-group">
                                    <input type="text" name="q"
                                           class="search form-control form-control-dark rounded-0 py-3"
                                           placeholder="Search  Events "
                                           value="{{session()->has('q') ? session('q') : ''}}" ng-model="searchName">
                                    <div class="input-group-append d-none d-md-flex">
                                        <button class="btn rounded-0" id="basic-addon"
                                                style="min-width: 100px; background-color: #424B55; color: white"><i
                ...
                <div id="events" class="content" ng-controller="eventController">
                    ...
                    <form method="get" action="{{route("admin.events.getpdf")}}">
                        <button type="submit">Download as PDF</button>
                    </form>
                </div>
                    ...
                    <div class="row" style="margin: 10px">
                        <form method="post" class="contact1-form validate-form" action="{{route('admin.events.store')}}"
                            ...
                            <div class="row"> <!-- first row -->
                                <div class="col-md-6">
                                    <label>Event name:<input type="text" name="name" placeholder="Name"
                                ...
                                <div class="col-md-3">
                                    <label>Maximum Attendee:<input type="number" name="max_capacity"
                            ...
                            <div class="row" align=" center"> <!-- second row -->
                                <div class="col-md-4">
                                    <label>Event fee (Baht) <input type="float" name="price" placeholder="0"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="row input-group-prepend">
                                        <label>Location <input id="location" type="textbox" name="location"
                                                               placeholder="Location" class="form-control" size="300"
                                                               style="width: 100%"></label>
                                        @if($errors->has('location'))
                                            <span class="help-block">{{ $errors->first('location') }}</span>
                                        @endif

                                        <input id="submit" type="button" value="Show on map"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Precondition<textarea id="precondition" name="precondition"
                                                                     class="form-control" row="20"
                            ...
                            <div class="col-md-12">
                                <label>Detail:
                                    <br><textarea rows="15" cols="80" name="detail" placeholder="Detail"
